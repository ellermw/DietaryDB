#!/bin/bash
# /opt/dietarydb/fix-categories.sh
# Fix category system to work independently of items

set -e

echo "======================================"
echo "Fixing Category System"
echo "======================================"
echo ""

cd /opt/dietarydb

# Step 1: First, ensure categories table exists and is populated
echo "Step 1: Setting up proper categories table..."
echo "============================================="
...
-- Insert existing categories from items (if not already there)
...
echo ""
echo "Categories table setup complete"
echo ""

# Step 2: Update backend with proper category handling
echo "Step 2: Updating backend with proper category handling..."
echo "========================================================="

cat > backend/server-categories-fixed.js << 'EOF'
...
app.get('/api/categories', async (req, res) => {
  try {
    ...
    // Combine categories with their item counts
...
# Deploy backend
docker cp backend/server-categories-fixed.js dietary_backend:/app/server.js
echo "Backend updated with proper category handling"
echo ""

# Step 3: Test the categories system
echo "Step 3: Testing categories system..."
echo "===================================="
...
RESPONSE=$(curl -s -X POST http://localhost:3000/api/categories \
  -H "Content-Type: application/json" \
  -d '{"category_name":"Test Category"}' 2>/dev/null)

if echo "$RESPONSE" | grep -q "success"; then
    echo "✅ Category creation working!"
else
...
echo "Testing categories retrieval..."
curl -s http://localhost:3000/api/categories 2>/dev/null | python3 -m json.tool | head -20 || echo "Categories endpoint test"
echo ""
...
echo ""
echo "======================================"
echo "Category System Fixed!"
echo "======================================"
echo ""
echo "✅ FIXES APPLIED:"
echo ""
echo "📦 CATEGORIES NOW:"
echo "  - Exist independently of items"
echo "  - Can have 0 items and still persist"
echo "  - Are stored in a dedicated categories table"
echo "  - Can be created successfully"
echo "  - Can only be deleted when they have 0 items"
echo ""
echo "🗂️ DEFAULT CATEGORIES ADDED:"
echo "  - Breakfast, Lunch, Dinner"
echo "  - Beverages, Snacks, Desserts"
echo "  - Sides, Condiments, Entrees"
echo "  - Soups, Salads, Appetizers"
echo ""
echo "Access at: http://15.204.252.189:3001"
echo "Go to the Items page to see all categories"
echo ""
echo "Note: Categories will now persist even when empty!"
echo ""
